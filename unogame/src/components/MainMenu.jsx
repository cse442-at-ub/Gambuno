...
function MainMenu() {
  ...
  return (
    <div className={styles.MainMenu_1_2}>
      ...
      <div className={styles.HelpTutorialCircle_154_45} onClick={() => setIsTutOpen(true)}><svg width="65" height="66" viewBox="0 0 65 66" fill="none" xmlns="http://www.w3.org/2000/svg">
