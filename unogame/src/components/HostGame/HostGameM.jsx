...
const HostGame = () => {
    ...
    return (
        <div className="h-screen w-screen bg-gradient-to-b from-orange-500 to-yellow-500 flex flex-col items-center justify-center relative px-6 overflow-hidden">
            ...
            {/* Title */}
            <h1 className="text-4xl sm:text-5xl font-bold text-black mt-12 mb-8 text-center">Host a Game</h1>
            ...
            <div className="flex gap-4 mb-6">
                <button className="px-6 py-3 bg-green-500 text-white text-xl font-bold shadow-lg rounded-xl border-4 border-black">
                    Easy
                </button>
                <button className="px-6 py-3 bg-yellow-500 text-black text-xl font-bold shadow-lg rounded-xl border-4 border-black">
                    Normal
                </button>
