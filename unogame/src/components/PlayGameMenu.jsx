...
export default function PlayGameMenu() {
  ...
  return (
    <div className={styles.PlayGameMenu_73_9}>
      <div className={styles.HelpTutorialCircle_154_45}><button className = {styles.arrowbutton} onClick = {goToTutorial}></button><svg width="40" height="40" viewBox="0 0 65 66" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={styles.ArrowLeftCircle_194_673}><button className = {styles.arrowbutton} onClick = {goToMainPage}></button>
      <svg width="40" height="40" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            <span className={styles.HostGame_283_144}>Host Game</span>
            <span className={styles.SelectGameType_283_146}>Select Game Type</span>
          </div>
        </div>
  );
}
